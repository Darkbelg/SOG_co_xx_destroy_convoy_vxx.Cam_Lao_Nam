...
if (side group player != CIVILIAN) then {
	...
	<br/>There is a convoy transporting fuel and ammo. We need to take out the fuel and ammo trucks.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
	<br/><font size='18' color='#80FF00'>SPECIAL TASKS</font>
	<br/>If any of the fuel or ammo truck gets to the end it is game over.
	<br/>
	<br/><font size='18' color='#80FF00'>ENEMY FORCES</font>
	<br/>A few gun trucks will be protecting the convoy.
	<br/>
